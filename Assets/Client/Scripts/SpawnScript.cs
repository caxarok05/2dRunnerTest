...
namespace Asset.Scripts 
{
    public class SpawnScript : MonoBehaviour
    {
        ...
        [SerializeField] private List<GameObject> _platformPrefab;
        ...
        {
            Instantiate(_platformPrefab[Random.Range(0, _platformPrefab.Count)], _spawnPlace, Quaternion.identity);
        }
